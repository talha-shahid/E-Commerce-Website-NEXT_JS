      ...
      <section class="text-gray-600 body-font overflow-hidden">
        <div class="container px-5 py-24 mx-auto ">
          <div class="lg:w-4/5 mx-auto flex flex-wrap">
            <img
              alt="ecommerce"
              class="shadow-xl lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded"
            ...
            <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div class="flex">
                ...
                <button
                  ...
                  class="flex ml-4 text-white bg-pink-500 border-0 px-2 md:px-6 py-2 focus:outline-none hover:bg-pink-600 rounded"
                >
                  Add to cart
                </button>
              ...
              <div
                ref={reff}
                class="mt-4 bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative hidden"
                role="alert"
              >
              ...
              <div className="pin mt-6">
                <input
                  ...
                  className="px-2 border-2 py-2 border-gray-200"
                />
                <button
