...
/>
    ...
    <div className="flex flex-wrap w-full -mt-2 p-5 flex-col items-center text-center bg-gradient-to-r from-indigo-300 via-blue-400 to-purple-500">
  ...
  <div className="container px-5 py-10 mx-auto ">
    ...
    <div className="flex flex-wrap -m-4">
      ...
      <div className="xl:w-1/3 md:w-1/2 p-4">
        <div className="border border-indigo-100 p-6 rounded-lg bg-indigo-200">
